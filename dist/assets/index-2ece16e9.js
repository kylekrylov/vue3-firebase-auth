 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bn(e){if(e)try{const t=new Date(Number(e));if(!isNaN(t.getTime()))return t.toUTCString()}catch{}}async function Og(e,t=!1){const n=Xe(e),r=await n.getIdToken(t),s=ki(r);j(s&&s.exp&&s.auth_time&&s.iat,n.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,o=i==null?void 0:i.sign_in_provider;return{claims:s,token:r,authTime:Bn(Ts(s.auth_time)),issuedAtTime:Bn(Ts(s.iat)),expirationTime:Bn(Ts(s.exp)),signInProvider:o||null,signInSecondFactor:(i==null?void 0:i.sign_in_second_factor)||null}}function Ts(e){return Number(e)*1e3}function ki(e){const[t,n,r]=e.split(".");if(t===void 0||n===void 0||r===void 0)return Er("JWT malformed, contained fewer than 3 sections"),null;try{const s=Gc(n);return s?JSON.parse(s):(Er("Failed to decode base64 JWT payload"),null)}catch(s){return Er("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function Ng(e){const t=ki(e);return j(t,"internal-error"),j(typeof t.exp<"u","internal-error"),j(typeof t.iat<"u","internal-error"),Number(t.exp)-Number(t.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _n(e,t,n=!1){if(n)return t;try{return await t}catch(r){throw r instanceof Pt&&Dg(r)&&e.auth.currentUser===e&&await e.auth.signOut(),r}}function Dg({code:e}){return e==="auth/user-disabled"||e==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qn{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(t){j(t.idToken,"internal-error"),j(typeof t.idToken<"u","internal-error"),j(typeof t.refreshToken<"u","internal-error");const n="expiresIn"in t&&typeof t.expiresIn<"u"?Number(t.expiresIn):Ng(t.idToken);this.updateTokensAndExpiration(t.idToken,t.refreshToken,n)}async getToken(t,n=!1){return j(!this.accessToken||this.refreshToken,t,"user-token-expired"),!n&&this.accessToken&&!this.isExpired?this.accessToken:this.refreshToken?(await this.refresh(t,this.refreshToken),this.accessToken):null}clearRefreshToken(){this.refreshToken=null}async refresh(t,n){const{accessToken:r,refreshToken:s,expiresIn:i}=await Fg(t,n);this.updateTokensAndExpiration(r,s,Number(i))}updateTokensAndExpiration(t,n,r){this.refreshToken=n||null,this.accessToken=t||null,this.expirationTime=Date.now()+r*1e3}static fromJSON(t,n){const{refreshToken:r,accessToken:s,expirationTime:i}=n,o=new Qn;return r&&(j(typeof r=="string","internal-error",{appName:t}),o.refreshToken=r),s&&(j(typeof s=="string","internal-error",{appName:t}),o.accessToken=s),i&&(j(typeof i=="number","internal-error",{appName:t}),o.expirationTime=i),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(t){this.accessToken=t.accessToken,this.refreshToken=t.refreshToken,this.expirationTime=t.expirationTime}_clone(){return Object.assign(new Qn,this.toJSON())}_performRefresh(){return nt("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ht(e,t){j(typeof e=="string"||typeof e>"u","internal-error",{appName:t})}class Vt{constructor(t){var{uid:n,auth:r,stsTokenManager:s}=t,i=Ri(t,["uid","auth","stsTokenManager"]);this.providerId="firebase",this.proactiveRefresh=new Lg(this),this.reloadUserInfo=null,this.reloadListener=null,this.uid=n,this.auth=r,this.stsTokenManager=s,this.accessToken=s.accessToken,this.displayName=i.displayName||null,this.email=i.email||null,this.emailVerified=i.emailVerified||!1,this.phoneNumber=i.phoneNumber||null,this.photoURL=i.photoURL||null,this.isAnonymous=i.isAnonymous||!1,this.tenantId=i.tenantId||null,this.providerData=i.providerData?[...i.providerData]:[],this.metadata=new ul(i.createdAt||void 0,i.lastLoginAt||void 0)}async getIdToken(t){const n=await _n(this,this.stsTokenManager.getToken(this.auth,t));return j(n,this.auth,"internal-error"),this.accessToken!==n&&(this.accessToken=n,await this.auth._persistUserIfCurrent(this),this.auth._notifyListenersIfCurrent(this)),n}getIdTokenResult(t){return Og(this,t)}reload(){return Mg(this)}_assign(t){this!==t&&(j(this.uid===t.uid,this.auth,"internal-error"),this.displayName=t.displayName,this.photoURL=t.photoURL,this.email=t.email,this.emailVerified=t.emailVerified,this.phoneNumber=t.phoneNumber,this.isAnonymous=t.isAnonymous,this.tenantId=t.tenantId,this.providerData=t.providerData.map(n=>Object.assign({},n)),this.metadata._copy(t.metadata),this.stsTokenManager._assign(t.stsTokenManager))}_clone(t){const n=new Vt(Object.assign(Object.assign({},this),{auth:t,stsTokenManager:this.stsTokenManager._clone()}));return n.metadata._copy(this.metadata),n}_onReload(t){j(!this.reloadListener,this.auth,"internal-error"),this.reloadListener=t,this.reloadUserInfo&&(this._notifyReloadListener(this.reloadUserInfo),this.reloadUserInfo=null)}_notifyReloadListener(t){this.reloadListener?this.reloadListener(t):this.reloadUserInfo=t}_startProactiveRefresh(){this.proactiveRefresh._start()}_stopProactiveRefresh(){this.proactiveRefresh._stop()}async _updateTokensIfNecessary(t,n=!1){let r=!1;t.idToken&&t.idToken!==this.stsTokenManager.accessToken&&(this.stsTokenManager.updateFromServerResponse(t),r=!0),n&&await Mr(this),await this.auth._persistUserIfCurrent(this),r&&this.auth._notifyListenersIfCurrent(this)}async delete(){const t=await this.getIdToken();return await _n(this,Pg(this.auth,{idToken:t})),this.stsTokenManager.clearRefreshToken(),this.auth.signOut()}toJSON(){return Object.assign(Object.assign({uid:this.uid,email:this.email||void 0,emailVerified:this.emailVerified,displayName:this.displayName||void 0,isAnonymous:this.isAnonymous,photoURL:this.photoURL||void 0,phoneNumber:this.phoneNumber||void 0,tenantId:this.tenantId||void 0,providerData:this.providerData.map(t=>Object.assign({},t)),stsTokenManager:this.stsTokenManager.toJSON(),_redirectEventId:this._redirectEventId},this.metadata.toJSON()),{apiKey:this.auth.config.apiKey,appName:this.auth.name})}get refreshToken(){return this.stsTokenManager.refreshToken||""}static _fromJSON(t,n){var r,s,i,o,a,c,l,u;const d=(r=n.displayName)!==null&&r!==void 0?r:void 0,p=(s=n.email)!==null&&s!==void 0?s:void 0,m=(i=n.phoneNumber)!==null&&i!==void 0?i:void 0,E=(o=n.photoURL)!==null&&o!==void 0?o:void 0,T=(a=n.tenantId)!==null&&a!==void 0?a:void 0,L=(c=n._redirectEventId)!==null&&c!==void 0?c:void 0,P=(l=n.createdAt)!==null&&l!==void 0?l:void 0,A=(u=n.lastLoginAt)!==null&&u!==void 0?u:void 0,{uid:H,emailVerified:D,isAnonymous:z,providerData:oe,stsTokenManager:ce}=n;j(H&&ce,t,"internal-error");const k=Qn.fromJSON(this.name,ce);j(typeof H=="string",t,"internal-error"),ht(d,t.name),ht(p,t.name),j(typeof D=="boolean",t,"internal-error"),j(typeof z=="boolean",t,"internal-error"),ht(m,t.name),ht(E,t.name),ht(T,t.name),ht(L,t.name),ht(P,t.name),ht(A,t.name);const x=new Vt({uid:H,auth:t,email:p,emailVerified:D,displayName:d,isAnonymous:z,photoURL:E,phoneNumber:m,tenantId:T,stsTokenManager:k,createdAt:P,lastLoginAt:A});return oe&&Array.isArray(oe)&&(x.providerData=oe.map(K=>Object.assign({},K))),L&&(x._redirectEventId=L),x}static async _fromIdTokenResponse(t,n,r=!1){const s=new Qn;s.updateFromServerResponse(n);const i=new Vt({uid:n.localId,auth:t,stsTokenManager:s,isAnonymous:r});return await Mr(i),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function am(e,t,n=!1){const{auth:r}=e,s="reauthenticate";try{const i=await _n(e,Cl(r,s,t,e),n);j(i.idToken,r,"internal-error");const o=ki(i.idToken);j(o,r,"internal-error");const{sub:a}=o;return j(e.uid===a,r,"user-mismatch"),zt._forOperation(e,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&Me(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cv(e,{displayName:t,photoURL:n}){if(t===void 0&&n===void 0)return;const r=Xe(e),i={idToken:await r.getIdToken(),displayName:t,photoUrl:n,returnSecureToken:!0},o=await _n(r,lm(r.auth,i));r.displayName=o.displayName||null,r.photoURL=o.photoUrl||null;const a=r.providerData.find(({providerId:c})=>c==="password");a&&(a.displayName=r.displayName,a.photoURL=r.photoURL),await r._updateTokensIfNecessary(o)}function um(e,t,n,r){return Xe(e).onIdTokenChanged(t,n,r)}function fm(e,t,n){return Xe(e).beforeAuthStateChanged(t,n)}function Rl(e,t,n,r){return Xe(e).onAuthStateChanged(t,n,r)}function Al(e){return Xe(e).signOut()}const Fr="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ul(e,t){return t?rt(t):(j(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ym=new sr(5e3,15e3),Xm="__/auth/iframe",Qm="emulator/auth/iframe",Zm={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},e_=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function t_(e){const t=e.config;j(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?Pi(t,Qm):`https://${e.config.authDomain}/${Xm}`,r={apiKey:t.apiKey,appName:e.name,v:rr},s=e_.get(e.config.apiHost);s&&(r.eid=s);const i=e._getFrameworks();return i.length&&(r.fw=i.join(",")),`${n}?${nr(r).slice(1)}`}async function n_(e){const t=await Jm(e),n=Je().gapi;return j(n,e,"internal-error"),t.open({where:document.body,url:t_(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Zm,dontclear:!0},r=>new Promise(async(s,i)=>{await r.restyle({setHideOnLeave:!1});const o=Ge(e,"network-request-failed"),a=Je().setTimeout(()=>{i(o)},Ym.get());function c(){Je().clearTimeout(a),s(r)}r.ping(c).then(c,()=>{i(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const y_=5*60,b_=Yc("authIdTokenMaxAge")||y_;let va=null;const E_=e=>async t=>{const n=t&&await t.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>b_)return;const s=n==null?void 0:n.token;va!==s&&(va=s,await fetch(e,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function Ui(e=ug()){const t=el(e,"auth");if(t.isInitialized())return t.getImmediate();const n=Jg(e,{popupRedirectResolver:g_,persistence:[Rm,gm,Nl]}),r=Yc("authTokenSyncURL");if(r){const i=E_(r);fm(n,i,()=>i(n.currentUser)),um(n,o=>i(o))}const s=Zh("auth");return s&&Xg(n,`http://${s}`),n}v_("Browser");const I_=Wh("authorization",()=>{const e=Rt(!1),t=Ui(),n=En({photo:"",name:"",mail:"",meta:{creation:"",lastSign:""}}),r=Rt(""),s=()=>{Rl(t,o=>{var a,c;o||(e.value=!o,r.value="",n.name="",n.photo="",n.mail="",n.meta.creation="",n.meta.lastSign=""),e.value=!!o,r.value=o==null?void 0:o.displayName,n.name=o==null?void 0:o.displayName,n.photo=o==null?void 0:o.photoURL,n.mail=o==null?void 0:o.email,n.meta.creation=(a=o==null?void 0:o.metadata)==null?void 0:a.creationTime,n.meta.lastSign=(c=o==null?void 0:o.metadata)==null?void 0:c.lastSignInTime})};return mi(()=>{s()}),{isLoggedIn:e,userAuth:n,userAuthName:r,onAuthState:s,handleSignOut:()=>{Al(t).then(()=>{console.log("Всё, вы не авторизованы")}).catch(()=>{console.log("что-то пошло не так c signOut()")}).finally(()=>{s()})}}});const w_={class:"header"},T_={class:"header__container container"},C_={class:"header__nav"},S_={class:"header__user header-user"},R_={class:"header-user__avatar"},A_=["src"],P_={key:1,class:"header-user__avatar-text"},k_={class:"header-user__drop-list"},O_={class:"header-user__drop-item"},N_={class:"header-user__drop-item"},D_=["onClick"],L_={class:"header-user__drop-item"},M_={class:"header-user__drop-item"},x_={__name:"TheHeader",setup(e){const t=xh(),n=I_(),{isLoggedIn:r,userAuth:s,userAuthName:i}=Kh(n),{onAuthState:o}=n,a=Ui(),c=Rt(null);Nd(c,L=>d());const l=Rt(!1),u=()=>{l.value=!l.value},d=()=>{l.value=!1},p=Ae(()=>r.value?Po:[Po[0]]),m=L=>L.trim().split(/[^a-zA-Zа-яА-Я]+/).filter(Boolean).map(H=>H.charAt(0)),E=Ae(()=>i.value?m(i.value).join("").toUpperCase():void 0),T=()=>{Al(a).then(()=>{console.log("Всё, вы не авторизованы"),t.push("/")}).catch(()=>{console.log("что-то пошло не так c signOut()")}).finally(()=>{o()})};return(L,P)=>{const A=ac("RouterLink");return Re(),tt("header",w_,[Te("div",T_,[Te("nav",C_,[(Re(!0),tt(ve,null,df(p.value,H=>(Re(),qn(A,{to:H.url,class:"header__nav-item"},{default:Ft(()=>[Pn(Wi(H.title),1)]),_:2},1032,["to"]))),256))]),Te("div",S_,[Te("div",{ref_key:"userBody",ref:c,class:Wr([{"--active":l.value},"header-user__body"]),onClick:u},[Te("div",R_,[Fe(r)?(Re(),tt(ve,{key:0},[Fe(s).photo?(Re(),tt("img",{key:0,class:"header-user__image",src:Fe(s).photo,alt:"avatar"},null,8,A_)):(Re(),tt("span",P_,Wi(E.value),1))],64)):(Re(),qn(Ad,{key:1}))]),Te("ul",k_,[Fe(r)?(Re(),tt(ve,{key:0},[Te("li",O_,[fe(A,{class:"header-user__drop-link link",to:"/profile"},{default:Ft(()=>[Pn(" Profile ")]),_:1})]),Te("li",N_,[Te("a",{class:"header-user__drop-link link",onClick:vd(T,["prevent"])}," Log out ",8,D_)])],64)):(Re(),tt(ve,{key:1},[Te("li",L_,[fe(A,{class:"header-user__drop-link link",to:"/register"},{default:Ft(()=>[Pn(" Register ")]),_:1})]),Te("li",M_,[fe(A,{class:"header-user__drop-link link",to:"/sing-in"},{default:Ft(()=>[Pn(" Sing In ")]),_:1})])],64))])],2)])])])}}},U_=ts(x_,[["__scopeId","data-v-8899cbfc"]]),F_={};function B_(e,t){return null}const $_=ts(F_,[["render",B_]]);const H_={class:"main"},j_={__name:"App",setup(e){return(t,n)=>{const r=ac("router-view");return Re(),tt(ve,null,[fe(U_),Te("main",H_,[fe(r,null,{default:Ft(({Component:s})=>[fe(wi,{name:"page",mode:"out-in"},{default:Ft(()=>[(Re(),qn(ff(s)))]),_:2},1024)]),_:1})]),fe($_)],64)}}},V_=ts(j_,[["__scopeId","data-v-9ec96a5b"]]),W_="modulepreload",K_=function(e){return"/vue3-firebase-auth/"+e},ya={},en=function(t,n,r){if(!n||n.length===0)return t();const s=document.getElementsByTagName("link");return Promise.all(n.map(i=>{if(i=K_(i),i in ya)return;ya[i]=!0;const o=i.endsWith(".css"),a=o?'[rel="stylesheet"]':"";if(!!r)for(let u=s.length-1;u>=0;u--){const d=s[u];if(d.href===i&&(!o||d.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${i}"]${a}`))return;const l=document.createElement("link");if(l.rel=o?"stylesheet":W_,o||(l.as="script",l.crossOrigin=""),l.href=i,document.head.appendChild(l),o)return new Promise((u,d)=>{l.addEventListener("load",u),l.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${i}`)))})})).then(()=>t()).catch(i=>{const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i})},$l=Lh({history:Yd("/vue3-firebase-auth/"),linkActiveClass:"--active",linkExactActiveClass:"--exact-active",routes:[{path:"/",component:()=>en(()=>import("./Home-818ffe69.js"),["assets/Home-818ffe69.js","assets/Section-b147db96.js","assets/Section-f91c96d5.css"])},{path:"/register",component:()=>en(()=>import("./Register-7175ffa4.js"),["assets/Register-7175ffa4.js","assets/Section-b147db96.js","assets/Section-f91c96d5.css","assets/Input-1e255465.js","assets/Input-1ba5767f.css","assets/Register-1452522f.css"]),meta:{requiresAuth:!1}},{path:"/sing-in",component:()=>en(()=>import("./SingIn-07837c9c.js"),["assets/SingIn-07837c9c.js","assets/Input-1e255465.js","assets/Input-1ba5767f.css","assets/Section-b147db96.js","assets/Section-f91c96d5.css","assets/SingIn-358131d8.css"]),meta:{requiresAuth:!1}},{path:"/list",component:()=>en(()=>import("./List-f9da6f6a.js"),["assets/List-f9da6f6a.js","assets/Section-b147db96.js","assets/Section-f91c96d5.css","assets/List-64e19bab.css"]),meta:{requiresAuth:!0}},{path:"/ui",component:()=>en(()=>import("./UI-101a27c4.js"),["assets/UI-101a27c4.js","assets/Section-b147db96.js","assets/Section-f91c96d5.css","assets/UI-9968cd75.css"]),meta:{requiresAuth:!0}},{path:"/profile",component:()=>en(()=>import("./Profile-533d7133.js"),["assets/Profile-533d7133.js","assets/Section-b147db96.js","assets/Section-f91c96d5.css","assets/Profile-03f8a666.css"]),meta:{requiresAuth:!0}}]}),z_=()=>new Promise((e,t)=>{const n=Rl(Ui(),r=>{n(),e(r)},t)});$l.beforeEach(async(e,t,n)=>{const r=e.matched.some(i=>i.meta.requiresAuth),s=await z_();r&&!s?n("/"):n()});const q_={apiKey:"AIzaSyATrfY9lvCkHSanuu9PYLC4--hZKC5q0ME",authDomain:"kylekrylov-e6e6f.firebaseapp.com",projectId:"kylekrylov-e6e6f",storageBucket:"kylekrylov-e6e6f.appspot.com",messagingSenderId:"977235481792",appId:"1:977235481792:web:7c750923e77ef5d290c925"};var G_="firebase",J_="9.23.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */an(G_,J_,"app");tl(q_);const Y_=Fh(),Fi=Ed(V_);Fi.use($l);Fi.use(Y_);Fi.mount("#app");export{iv as A,df as B,Wr as C,sv as D,ev as E,ve as F,yt as G,nv as H,Pn as I,ts as _,Re as a,qn as b,Ae as c,Te as d,xh as e,En as f,fe as g,Ui as h,ov as i,cv as j,lv as k,Q_ as l,av as m,tt as n,mi as o,X_ as p,tv as q,Rt as r,Kh as s,Wi as t,I_ as u,on as v,Ft as w,vd as x,Z_ as y,rv as z};
